...
var utils = {
    ...
    wrapUser: function (user) {
        ...
        if (photoPath) {
            ...
            user.avatar = {
                '30': '//static.mgcheng.com/static/images/avatar/_30_30.gif',
                '120': '//static.mgcheng.com/static/images/avatar/_120_120.gif',
                '200': '//static.mgcheng.com/static/images/avatar/_200_120.gif'
            }
        }
        return user
    },
    ...
    ajax: function (options) {
        ...
        if (options.data) {
            param.param = this.extend(param.param, options.data)
        }
    ...
    getApiData: function (service, req, callback) {
        ...
        self.sendRequest(options, callback, service)
    },
    sendRequest: function (options, callback, service) {
